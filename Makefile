...
./build/int80h/int80.o: ./src/int80h/int80.c
	i686-elf-gcc $(INCLUDES) -I ./src/int80h $(FLAGS) -std=gnu99 -c ./src/int80h/int80.c -o ./build/int80h/int80.o

./build/int80h/misc.o: ./src/int80h/misc.c
	i686-elf-gcc $(INCLUDES) -I ./src/int80h $(FLAGS) -std=gnu99 -c ./src/int80h/misc.c -o ./build/int80h/misc.o

./build/int80h/io.o: ./src/int80h/io.c
	i686-elf-gcc $(INCLUDES) -I ./src/int80h $(FLAGS) -std=gnu99 -c ./src/int80h/io.c -o ./build/int80h/io.o
...
./build/int80h/process.o: ./src/int80h/process.c
	i686-elf-gcc $(INCLUDES) -I ./src/int80h $(FLAGS) -std=gnu99 -c ./src/int80h/process.c -o ./build/int80h/process.o
