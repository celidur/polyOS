...
./build/loader/elfloader.o: ./src/loader/elfloader.c
	i686-elf-gcc $(INCLUDES) -I ./src/loader $(FLAGS) -std=gnu99 -c ./src/loader/elfloader.c -o ./build/loader/elfloader.o
